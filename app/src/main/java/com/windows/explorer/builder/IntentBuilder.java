...
public class IntentBuilder {
    ...
    public static void viewFile(final MainActivity activity, final String filePath) {
        ...
        if (!TextUtils.isEmpty(type) && !TextUtils.equals(type, "*/*")) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                apk_path = FileProvider.getUriForFile(activity, "com.aueui.windows10.fileProvider", new File(filePath));
    ...
    public static Intent buildSendFile(MainActivity activity,ArrayList<FileInfo> files) {
        ...
        for (FileInfo file : files) {
            ...
            Uri apk_path;
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.M) {
                apk_path = FileProvider.getUriForFile(activity, "com.aueui.windows10.fileProvider", fileIn);
