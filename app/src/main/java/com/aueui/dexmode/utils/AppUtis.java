...
import com.aueui.dexmode.entity.AppListPosition;
...
import com.aueui.dexmode.receiver.AdminReceiver;
import com.aueui.dexmode.web.URIConfig;
import com.aueui.dexmode.widget.MenuSelectDialog;
    ...
    public static List<DesktopEntity> initDesktopAppList(Context context) {
        ...
        if (appEntities.size() == 0) {
            ...
            appEntities.add(getAppEntity("回收站"/*, "" + R.mipmap.recyclestationnull*/, ""
                    , DesktopEntity.DesktopType.system));
            appEntities.add(getAppEntity("DEX设置"/*, "" + R.mipmap.control_panel*/, ""
                    , DesktopEntity.DesktopType.system));
