package com.aueui.dexmode.activity;
...
import com.aueui.dexmode.activity.base.BaseActivity;
import com.aueui.dexmode.adapter.AppGridAdapter;
import com.aueui.dexmode.adapter.AppListAdapter;
import com.aueui.dexmode.adapter.TaskBarAdapter;
import com.aueui.dexmode.adapter.base.SimpleViewPagerAdapter;
...
import com.aueui.dexmode.receiver.BatteryChangedReceiver;
import com.aueui.dexmode.receiver.InstallReceiver;
import com.aueui.dexmode.receiver.MainMessageReceiver;
import com.aueui.dexmode.receiver.ScreenListener;
import com.aueui.dexmode.receiver.TimeReceiver;
import com.aueui.dexmode.receiver.UninstallReceiver;

import com.aueui.dexmode.service.ListenerNotificationService;


//import com.aueui.windows10.utils.AdUtils;
import com.aueui.dexmode.utils.AppUtis;

import com.aueui.dexmode.utils.DensityUtils;
import com.aueui.dexmode.utils.DesktopUtils;
import com.aueui.dexmode.utils.FragmentUtils;

import com.aueui.dexmode.utils.SavePreference;

import com.aueui.dexmode.widget.HorizontalListView;
import com.aueui.dexmode.widget.OperationCenterDialog;
/*import com.aueui.dexmode.widget.QuickWindowsView;*/
import com.aueui.dexmode.widget.StartMenuDialog;
   ...
   /* //编写 javaScript方法
    ...
    private void initViewPager() {
       ...
       /* viewPagerStrings.add("quick");*/
        ...
        /*recyclerView.setPadding(DensityUtils.dp2px(0), DensityUtils.dp2px(0)
                , DensityUtils.dp2px(0), DensityUtils.dp2px(0));
...
*/
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == SettingsFragment.IMAGE_1_REQUEST_CODE
                || requestCode == SettingsFragment.IMAGE_2_REQUEST_CODE
                || requestCode == SettingsFragment.IMAGE_3_REQUEST_CODE) {
